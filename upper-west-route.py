...
towns = [
    "Wa", "Dorimon", "Kundungu", "Nadowli", "Lawra", "Nandom", "Hamile", 
       "Jirapa", "Busie", "Gwolu"
]

town_coords = {
    # Add more town coordinates here if you have them
    "Kundungu": (10.134960988315385, -1.7458391577007804),
    "Busie": (10.477472839871403, -2.502565584767325)
...
mymap.save("upper-west-route.html")
...
driver.get("file://" + "/path/to/upper-west-route.html")  # Ensure correct file path
driver.set_window_size(800, 600)
driver.save_screenshot("upper-west-route.png")

# Close the browser
driver.quit()

# Display the generated map image using matplotlib
img = plt.imread("upper-west-route.png")
plt.imshow(img)
