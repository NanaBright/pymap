...
town_coords = {
    ...
    "Npanchiraso": (5.8504480450196015, -1.2829253551426258),
    "Awutu Breku": (5.698996100894129, -0.6050197215549646),
    "Wawase": (5.417353793481917, -1.4781117454767285)
}
...
driver.get("file://" + "/path/to/central-route.html")  # Ensure correct file path
driver.set_window_size(800, 600)
driver.save_screenshot("central-route.png")

# Close the browser
driver.quit()

# Display the generated map image using matplotlib
img = plt.imread("central-route.png")
plt.imshow(img)
