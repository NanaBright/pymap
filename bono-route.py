...
towns = [
    "Sunyani", "Nsuatre", "Berekum",
    "Senase", 
    "Jinijini", "Wamfie", "Dormaa Ahenkro", "Drobo"
]
...
driver.get("file://" + "/path/to/bono-route.html")  # Ensure correct file path
driver.set_window_size(800, 600)
driver.save_screenshot("bono-route.png")

# Close the browser
driver.quit()

# Display the generated map image using matplotlib
img = plt.imread("bono-route.png")
plt.imshow(img)
