...
towns = [
        "Yagaba", "Walewale", "Nalerigu", "Nakpanduri", "Bunkpurugu", "Chereponi"
]
...
mymap.save("north-east-route.html")
...
driver.get("file://" + "/path/to/north-east-route.html")  # Ensure correct file path
driver.set_window_size(800, 600)
driver.save_screenshot("north-east-route.png")

# Close the browser
driver.quit()

# Display the generated map image using matplotlib
img = plt.imread("north-east-route.png")
plt.imshow(img)
