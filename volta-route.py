...
towns = [
   "Hohoe", "Golokwati", "Kpando", "Vakpo", "Have Etoe", "Kpeve", "Logba Alakpeti", 
        "Dzolo Gbogame", "Ho", "Agotime Kpetoe", "Waya", "Mafi Kumase Proper", 
        "Ziope", "Ave Dakpa", "Dzodze", "Tadzevu", "Akatsi", "Aflao", "Anloga", 
        "Sogakope", "Kasseh"
]

town_coords = {
    # Add more town coordinates here if you have them
    "Mafi Kumase Proper": (6.273165267773049, 0.5733597009432632),
    "Tadzevu": (6.191584560175295, 0.8938407914688862)
}
...
driver.get("file://" + "/path/to/volta-route.html")  # Ensure correct file path
driver.set_window_size(800, 600)
driver.save_screenshot("volta-route.png")

# Close the browser
driver.quit()

# Display the generated map image using matplotlib
img = plt.imread("volta-route.png")
plt.imshow(img)
