...
towns = [
    "Navrongo", "Paga", "Bolgatanga", "Bongo", "Kongo", "Zebilla", "Bawku", 
        "Pusiga", "Binduri", "Garu", "Tempane", "Tongo", "Sandema", "Fumbisi"
]
...
mymap.save("upper-east-route.html")
...
driver.get("file://" + "/path/to/upper-east-route.html")  # Ensure correct file path
driver.set_window_size(800, 600)
driver.save_screenshot("upper-east-route.png")

# Close the browser
driver.quit()

# Display the generated map image using matplotlib
img = plt.imread("upper-east-route.png")
plt.imshow(img)
