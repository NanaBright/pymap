...
towns = [
    ...
    "Somanya", "Odumase Krobo", "Atimpoku", "Asesewa", "Begoro", "Oseim", "New Tafo Akim",
...
town_coords = {
    "Odumase Krobo":  (5.960160287675467, 0.05132561549527757),
    "Ofoase Ayirebi": (6.0839536006472414, -1.1241268549524412)
...
driver.get("file://" + "/path/to/eastern-route.html")  # Ensure correct file path
driver.set_window_size(800, 600)
driver.save_screenshot("eastern-route.png")

# Close the browser
driver.quit()

# Display the generated map image using matplotlib
img = plt.imread("eastern-route.png")
plt.imshow(img)
