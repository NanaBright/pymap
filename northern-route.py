...
towns = [
    "Saboba", "Yendi", "Zabzugu", "Tatale", "Gushiegu", "Karaga", "Savelugu", 
        "Tamale", "Kumbungu", "Tolon", "Sang", "Lepusi", "Bimbila", "Salaga", 
        "Wulensi", "Kpandai"
]
...
mymap.save("northern-route.html")
...
driver.get("file://" + "/path/to/northern-route.html")  # Ensure correct file path
driver.set_window_size(800, 600)
driver.save_screenshot("northern-route.png")

# Close the browser
driver.quit()

# Display the generated map image using matplotlib
img = plt.imread("northern-route.png")
plt.imshow(img)
