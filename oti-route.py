...
towns = [
   "Chindiri", "Kete Krachi", "Dambai", "Nkwanta", "Domanko", "Abrubruwa", 
        "Kadjebi", "Jasikan", "Kwamikrom"
]

town_coords = {
    # Add more town coordinates here if you have them
    "Chindiri": (8.133431894666542, -0.14979794205373811),
    "Domanko": (8.687347755930816, 0.18110266038700443)
}
...
driver.get("file://" + "/path/to/oti-route.html")  # Ensure correct file path
driver.set_window_size(800, 600)
driver.save_screenshot("oti-route.png")

# Close the browser
driver.quit()

# Display the generated map image using matplotlib
img = plt.imread("oti-route.png")
plt.imshow(img)
